...
*   **排版修复**：移除了之前的 `leadingIcon/trailingIcon` 参数，内部直接使用 `inline-flex items-center justify-center gap-2 whitespace-nowrap`。在插槽中自由混排 Lucide 图标和文本时，保证绝对水平居中对齐，绝无意外换行。
