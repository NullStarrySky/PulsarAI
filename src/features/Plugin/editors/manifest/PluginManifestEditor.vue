...
import { resolvePluginComponentByName } from "@/features/Plugin/editors/vue/plugin-vue-runtime";
import {
  parsePluginManifest,
  setManifestValue,
...
import ManifestCheckboxControl from "@/features/Plugin/editors/manifest/controls/ManifestCheckboxControl.vue";
import ManifestInputControl from "@/features/Plugin/editors/manifest/controls/ManifestInputControl.vue";
import ManifestMediaSelectControl from "@/features/Plugin/editors/manifest/controls/ManifestMediaSelectControl.vue";
import ManifestModelSelectControl from "@/features/Plugin/editors/manifest/controls/ManifestModelSelectControl.vue";
import ManifestPathSelectControl from "@/features/Plugin/editors/manifest/controls/ManifestPathSelectControl.vue";
import ManifestSelectControl from "@/features/Plugin/editors/manifest/controls/ManifestSelectControl.vue";
import ManifestSliderControl from "@/features/Plugin/editors/manifest/controls/ManifestSliderControl.vue";
import ManifestSwitchControl from "@/features/Plugin/editors/manifest/controls/ManifestSwitchControl.vue";
import ManifestTextareaControl from "@/features/Plugin/editors/manifest/controls/ManifestTextareaControl.vue";
