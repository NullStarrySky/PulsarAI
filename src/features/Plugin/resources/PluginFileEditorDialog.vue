...
import type { FileMeta, PluginData, Pulse } from "../dataflow";
...
const fileMeta = computed<FileMeta | undefined>(() => {
	const meta = current.value?.meta;
	return meta && "priority" in meta ? meta : undefined;
});
const draft = ref("");
