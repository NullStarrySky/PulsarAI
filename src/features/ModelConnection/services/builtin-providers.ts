...
export const builtinModelProviders: ModelProviderDefinition[] = [
  {
    ...nativeProvider("openai", "OpenAI", "OpenAI 官方 AI SDK Provider。", "https://api.openai.com/v1"),
    enabled: true,
    models: [
      { id: "gpt-4o", name: "GPT-4o", apiType: "chat", contextSize: 128000, enabled: true },
      { id: "gpt-4o-mini", name: "GPT-4o mini", apiType: "chat", contextSize: 128000, enabled: true },
      { id: "text-embedding-3-small", name: "Text Embedding 3 Small", apiType: "embedding", enabled: true },
      { id: "gpt-image-2", name: "GPT Image 2", apiType: "image", enabled: false },
      { id: "gpt-4o-mini-tts", name: "GPT-4o mini TTS", apiType: "tts", enabled: false },
  ...
  {
    ...nativeProvider("deepseek", "DeepSeek", "DeepSeek 官方 AI SDK Provider，支持结构化 reasoning 流。", "https://api.deepseek.com"),
    models: [
      { id: "deepseek-v4-flash", name: "DeepSeek V4 Flash", apiType: "chat", contextSize: 64000, enabled: true },
      { id: "deepseek-v4-pro", name: "DeepSeek V4 Pro", apiType: "chat", contextSize: 64000, enabled: true },
    ],
  },
  nativeProvider("xai", "xAI Grok", "xAI Grok 官方 AI SDK Provider。"),
  nativeProvider("azure", "Azure OpenAI", "Azure OpenAI 官方 AI SDK Provider。"),
  nativeProvider("anthropic", "Anthropic", "Anthropic 官方 AI SDK Provider。"),
  nativeProvider("amazon-bedrock", "Amazon Bedrock", "Amazon Bedrock 官方 AI SDK Provider。"),
  nativeProvider("google", "Google", "Google Gemini 官方 AI SDK Provider。"),
  nativeProvider("mistral", "Mistral", "Mistral 官方 AI SDK Provider。"),
  nativeProvider("togetherai", "Together.ai", "Together.ai 官方 AI SDK Provider。"),
  ...
  nativeProvider("perplexity", "Perplexity", "Perplexity 官方 AI SDK Provider。"),
  nativeProvider("elevenlabs", "ElevenLabs", "ElevenLabs 官方 AI SDK Provider。"),
  ...
  nativeProvider("assemblyai", "AssemblyAI", "AssemblyAI 官方 AI SDK Provider。"),
