import { type CrepeConfig, CrepeFeature } from "@milkdown/crepe";
import type { AIPromptContext } from "@milkdown/crepe/feature/ai";
import type { ModelMessage } from "ai";
import { generateAuxiliaryText } from "@/features/Plugin/agent/runtime/default-agent";
...
export const conversationCrepeFeatureConfigs: NonNullable<
...
async function* conversationAIProvider(
