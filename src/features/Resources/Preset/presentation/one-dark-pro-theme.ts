...
export const oneDarkProHighlightStyle = HighlightStyle.define([
  ...
  { tag: [tags.color, tags.constant(tags.name), tags.standard(tags.name)], color: c.orange },
  ...
  { tag: [tags.atom, tags.bool, tags.special(tags.variableName)], color: c.orange },
  { tag: [tags.processingInstruction, tags.string, tags.inserted], color: c.green },
