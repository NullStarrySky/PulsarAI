...
import { createAgentResourceProvider } from "@/features/Agent/runtime/default-agent";
import {
...
} from "@/features/Resources/Plugin/editors/chat/plugin-chat";
import {
  collectPluginCustomTools,
  createPluginCustomToolFunction,
} from "@/features/Resources/Plugin/runtime/plugin-custom-tools";
import {
  type Plugin,
} from "@/features/Resources/Plugin/tree/plugin-types";
import { createPluginSelfApi } from "@/features/Resources/Plugin/runtime/plugin-self-api";
import { pluginFixedSettingValue } from "@/features/Resources/Plugin/runtime/plugin-generate-path";
...
import { buildFeatureApiRuntime } from "@/features/Capabilities/registry";
import {
...
} from "@/features/Resources/Conversation/generation/conversation-memory";
import {
...
export async function runConversationGeneration(
  ...
  const capabilityRuntime = buildFeatureApiRuntime();
