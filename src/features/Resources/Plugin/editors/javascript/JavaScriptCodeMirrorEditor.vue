...
import { oneDarkPro, oneDarkProColors } from "@/features/Resources/Plugin/editors/javascript/one-dark-pro-theme";
  ...
  if (importCall) {
    return {
      ...
      options: [
        {
          label: "import(path)",
          apply: 'import("../../../../../../../..\..\src\features\Resources\Plugin\presentation\resource.md")',
          detail: "导入并展开资源内容",
          type: "function",
        },
        {
